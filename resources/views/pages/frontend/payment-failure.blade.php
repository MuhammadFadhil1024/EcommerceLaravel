    ...
    <section class="bg-gray-50 py-8 px-4">
        <div class="container mx-auto max-w-6xl">
            <ul class="flex items-center text-sm md:text-base text-gray-500">
                ...
                <li>
                    <span class="font-semibold text-gray-900">Payment Failed</span>
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="py-16 md:py-24 bg-gray-50">
        <div class="container mx-auto px-4 max-w-lg text-center">
            <div class="bg-white p-8 md:p-12 rounded-3xl shadow-lg">
                ...
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Payment Failed</h1>
                <p class="text-gray-500 mb-2">Your payment was cancelled or could not be processed.</p>
                <p class="text-sm text-gray-400">Please try again or choose a different payment method.</p>
                @if ($ref !== '')
                    <p class="text-sm text-gray-400 mt-2">Reference: <span class="font-mono font-medium text-gray-600">{{ $ref }}</span></p>
                @endif

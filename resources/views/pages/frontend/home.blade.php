        ...
        <div
            ...
            <div>
                <a href="{{ route('products') }}"
                    class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200" wire:navigate>Explore
                    Now</a>
            </div>
        </div>
                ...
                @foreach ($this->products as $product)
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative"
                            ...
                            <img src="{{ $product->galleries()->exists() ?  asset('storage/' . $product->galleries->first()->image) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                        ...
                        <a href="{{ route('detail', $product->slug) }}" class="stretched-link" wire:navigate>
                            <!-- fake children -->
                        </a>
                    </div>
                @endforeach
